    ...
    else if($typeid == 999)
	{
		...
		if(!is_array($row))
		{
			...
			if(!empty($linkInfo)){
				...
				$revalue=<<<EOT
<li><a href='http://ad.dedecms.com' target='_blank' title='DedeCMS广告'>DedeCMS广告</a></li><li><a href='http://service.dedecms.com' target='_blank' title='技术客户服务中心'>
技术客户服务中心</a></li><li><a href='http://ask.dedecms.com' target='_blank' title='技术问答'>
技术问答</a></li><li><a href='http://tools.dedecms.com' target='_blank' title='站长工具'>
站长工具</a></li><li><a href='http://site.desdev.cn' target='_blank' title='DedeCMS建站中心'>
DedeCMS建站中心</a></li><li><a href='http://help.dedecms.com' target='_blank' title='技术CMS帮助中心'>
技术CMS帮助中心</a></li><li><a href='http://' target='_blank' title=''>
</a></li>
EOT;
			}
			$row['reval'] = $revalue;
